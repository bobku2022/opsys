...
svn co https://github.com/cocokfeng/luci-theme-argon/trunk feeds/kenzo/luci-theme-argon
svn co https://github.com/cocokfeng/luci-app-argon-config/trunk feeds/kenzo/luci-app-argon-config
...
cp -f package/lean/luci-argon/htdocs/luci-static/argon/img/bg1.jpg feeds/kenzo/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
...
echo -e "--------------------------------------------------------------\n   openwrt by ccf built on "$(date +%Y.%m.%d)"\n--------------------------------------------------------------" >> package/base-files/files/etc/banner
